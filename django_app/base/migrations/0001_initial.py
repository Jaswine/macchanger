    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('card_text_border_bottom', models.CharField(blank=True, default='', max_length=20)),
                ...
                ('card_icon_color', models.CharField(blank=True, max_length=20)),
                ('font_icon_size', models.CharField(default='36px', max_length=20)),
                ('card_icon_color_hover', models.CharField(blank=True, max_length=20)),
